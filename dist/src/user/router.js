...
exports.UserRouter.post("/pay", [is_auth_1.isAuth], (0, utils_1.wrapAsync)(controller_1.userController.pay));
exports.UserRouter.post("/uchecrypt/webhook", (0, utils_1.wrapAsync)(controller_1.userController.verify_payment));
